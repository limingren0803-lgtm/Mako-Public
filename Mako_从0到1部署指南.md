...
本文档面向第一次接触 Mako 的新手，按顺序执行即可在本机启动完整服务，并完成基础验证。

Mako 是一个基于 FastAPI 的 AI Career Intelligence System，核心依赖包括：

- Mako API：主应用服务，默认端口 `8000`
...
Mako 会从 `skills/` 目录加载业务规则，用于增强不同 Agent 的回复能力。

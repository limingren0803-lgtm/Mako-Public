...
v1.9.0 保持现有 API 路径、Redis key、ChromaDB collection、CareerProfile Schema 和知识登记库结构不变。Redis、ChromaDB、Prometheus、Nginx 与知识登记库继续使用现有 volume 名称和挂载路径。新增响应分组和批量管理能力不会改变既有聊天与记忆行为。
